...
$global_config['error_send_email'] = 'webmaster@nuke4.my';
$global_config['error_set_logs'] = 1;
$global_config['file_allowed_ext'] = ['adobe','archives','audio','documents','flash','images','real','text','video'];
...
$global_config['ftp_user_pass'] = '75Epu_7_Eqb-AxT91St0cQ,,';
...
$global_config['my_domains'] = 'nuke4.my';
